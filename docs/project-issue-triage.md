...
| --- | --- | --- |
| Migration kit / file migrations / pull | #153, #154, #157, #158, #169, #273, #274, #275, #276, #277, #278, #279, #280 | Normalize before Slice 0; detailed issue triage is incorporated below. |
...
Detailed triage for issues whose current bodies mention migration filenames, `kit.Migrate`, `generate`, `check`, `push`, or `pull` is now incorporated in this document below.
...
The following detailed migration-kit issue triage was previously recorded in a focused file-migrations review artifact and has been merged here so this document is the single project-wide issue triage entry point.
